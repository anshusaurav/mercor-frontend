        ...
        <div className="block md:flex justify-between align-center text-white py-10 mt-24 md:mt-0">
          <div className="flex flex-1 justify-center md:justify-start items-center">
            <div className="flex justify-start">
              ...
              <div className="flex items-center border border-white w-auto rounded py-3 px-3 mx-2 bg-black">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="22"
          ...
          <div className="hidden lg:flex flex-none justify-center items-center mx-12">
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
          ...
          <div className="block md:flex flex-1 justify-between align-center mt-8 md:mt-0">
            ...
            <div className="flex flex-1 justify-center space-x-6 self-center mt-8 md:mt-0">
