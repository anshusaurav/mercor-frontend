  ...
  return (
    <footer className="absolute bottom-0 left-0 right-0 z-50">
      <div className="mx-auto min-w-full px-16 md:px-12 sm: px-6">
        <div className="flex flex-wrap md:flex-nowrap justify-between align-center text-white py-10">
          <div className="flex flex-1 justify-start items-center">
            <div className="flex justify-start">
              <div className="flex items-center border border-white w-auto rounded px-4 py-4 w-52 mx-2 bg-black">
                <svg
                ...
                <p className="text-xs md:text-xxs ml-2"> APP STORE </p>
              </div>
              <div className="flex items-center border border-white w-auto rounded px-4 py-4 w-44 mx-2 bg-black">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="22"
                ...
                <p className="text-xs md:text-xxs ml-2"> GOOGLE PLAY </p>
              </div>
            </div>
          </div>
          <div className="flex flex-none justify-center items-center mx-12">
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
          ...
          <div className="flex flex-1 justify-between align-center">
            <p className="text-xxs font-light text-regal-grey flex-1 self-center font-agrandirlight">
            ...
            <div className="flex flex-1 justify-center space-x-6 self-center">
